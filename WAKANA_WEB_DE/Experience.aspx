<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="Experience.aspx.cs" Inherits="WAKANA_WEB_DE.Experience" %>
    ...
    <section class="section swatch-blue text-center section-text-shadow section-no-inner-shadow">
        ...
        <div class="container">
                    ...
                    <div class="col-md-12">
                                ...
                                <center>
                                    <a class="lobstertitle" >
                                        <asp:Literal runat="server" ID="Literal4" Text="<%$ Resources:Index, experienciawakanat %>"></asp:Literal>
                                    </a>
                                </center>
                    </div>
                </div>
                    ...
                    <div class="col-md-12">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <img src="../assets/images/experience/family.jpg" alt="" class="ImagenLoca">
                            </div>
                            <div class="col-md-6 margenazo">
                                <p class="cmn-t-underline "><asp:Literal runat="server" ID="Literal1" Text="<%$ Resources:Index, experienciacontufamilia %>"></asp:Literal></p>
                                <p class="texto"></br></br></br></br></br></br></br></br></p>
                                <center>
              <a href="Activities.aspx" class="wakanasublink"><asp:Literal runat="server" ID="Literal2" Text="<%$ Resources:Index, experienciaexploraractividades %>"></asp:Literal></a>
            </center>
                            </div>
                        </div>
                        </br>
           <div class="row">
               <div class="col-md-6">
                   <center>
              <img src="../assets/images/experience/friends.jpg" alt="" class="ImagenLoca">
            </center>
               </div>
               <div class="col-md-6 margenazo">
                   <p class="cmn-t-underline "><asp:Literal runat="server" ID="Literal5" Text="<%$ Resources:Index, experienciacontusamigos %>"></asp:Literal></p>
                   <p class="texto"></br></br></br></br></br></br></br></br></p>
                   <center>
               <a href="Activities.aspx" class="wakanasublink"><asp:Literal runat="server" ID="Literal3" Text="<%$ Resources:Index, experienciaexploraractividades %>"></asp:Literal></a>
            </center>
               </div>
           </div>
                        </br>
          <div class="row">
              <div class="col-md-6">
                  <center>
              <img src="../assets/images/experience/team.jpg" alt="" class="ImagenLoca">
            </center>
              </div>
              <div class="col-md-6 margenazo">
                  <p class="cmn-t-underline "><asp:Literal runat="server" ID="Literal6" Text="<%$ Resources:Index, experienciacontuequipo %>"></asp:Literal></p>
                  <p class="texto"></br></br></br></br></br></br></br></br></p>
                  <center>
              <a  href="#" onclick="ShowContactMod();return false;"  class="wakanasublink"><asp:Literal runat="server" ID="Literal7" Text="<%$ Resources:Index, experienciareserva %>"></asp:Literal></a>
            </center>
              </div>
          </div>
