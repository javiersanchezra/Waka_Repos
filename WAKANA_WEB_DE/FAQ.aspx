            ...
            <div class="portfolio-container element-normal-top element-no-bottom">
                <div class="row">
                    <div class="col-md-12">
                                ...
                                <center>
                                    <a class="lobstertitle" >Frequently Asked Questions</a>
                                </center>
                    </div>
                    <div class="col-md-12">
                        <br />
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div style="background-color: rgba(0,0,0,.5);">
                            ...
                            <p style="opacity: 1 !important; padding-left: 15px; padding-right: 15px; padding-top: 15px; text-align: left; font-family: Quicksand; font-size: 25px; font-weight: 300; color: white; z-index: 25;">What's Wakana Lake?</p>
                            <p style="padding-left: 15px; padding-right: 15px; padding-bottom: 15px; text-align: left; font-family: Quicksand; font-size: 15px; font-weight: 200; color: white">
                                Wakana Lake is a multiadventure complex in a natural environment, located in Los alcornocales Natural Park, at the edge of El Celemin´s reservoir.
                                    <br />
                               Wakana Lake is a place to share. Ideal for all types of clients, couples wishing to relax, families looking for a different experience that complements their holidays, or groups of friends or companies needing a customised program.
                            </p>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div style="background-color: rgba(0,0,0,.5);">
                            <p style="opacity: 1 !important; padding-left: 15px; padding-right: 15px; padding-top: 15px; text-align: left; font-family: Quicksand; font-size: 25px; font-weight: 300; color: white; z-index: 25;">Can anyone freely access to Wakana Lake?</p>
                            <p style="padding-left: 15px; padding-right: 15px; padding-bottom: 15px; text-align: left; font-family: Quicksand; font-size: 15px; font-weight: 200; color: white">A fee of  5,00 Euros per person is required to access Wakana Lake and a Disclaimer Form needs to be filled in and signed by any person entering the property.</p>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div style="background-color: rgba(0,0,0,.5);">
                            <p style="opacity: 1 !important; padding-left: 15px; padding-right: 15px; padding-top: 15px; text-align: left; font-family: Quicksand; font-size: 25px; font-weight: 300; color: white; z-index: 25;">Is the water from the reservoir of El Celemin suitable for swimming?</p>
                            <p style="padding-left: 15px; padding-right: 15px; padding-bottom: 15px; text-align: left; font-family: Quicksand; font-size: 15px; font-weight: 200; color: white">Yes, abolutely. We have carried out a complete analysis of the waters from the reservoir, which has shown that they are in excellent conditions for swimming.</p>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div style="background-color: rgba(0,0,0,.5);">
                            ...
                            <p style="padding-left: 15px; padding-right: 15px; padding-bottom: 15px; text-align: left; font-family: Quicksand; font-size: 15px; font-weight: 200; color: white">The reservoir of El Celemin extends over an area of 473 hectares and has a capacity of 43 cubic hectometers.</p>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div style="background-color: rgba(0,0,0,.5);">
                            <p style="opacity: 1 !important; padding-left: 15px; padding-right: 15px; padding-top: 15px; text-align: left; font-family: Quicksand; font-size: 25px; font-weight: 300; color: white; z-index: 25;">How big is Wakana Lake?</p>
                            <p style="padding-left: 15px; padding-right: 15px; padding-bottom: 15px; text-align: left; font-family: Quicksand; font-size: 15px; font-weight: 200; color: white">Wakana Lake has an area of almost 20 hectares (additionally to the reservoir), where you can enjoy a multitud of activities.</p>
                        </div>
                    </div>
                    <%--<div class="col-md-6">
                                <div style="background-color:rgba(0,0,0,.5); ">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div style="background-color: rgba(0,0,0,.5);">
                            ...
                            <p style="opacity: 1 !important; padding-left: 15px; padding-right: 15px; padding-top: 15px; text-align: left; font-family: Quicksand; font-size: 25px; font-weight: 300; color: white; z-index: 25;">What activities can I do at Wakana Lake?</p>
                            <p style="padding-left: 15px; padding-right: 15px; padding-bottom: 15px; text-align: left; font-family: Quicksand; font-size: 15px; font-weight: 200; color: white">
                                Many activities can be carried out in our complex, some of which requires assistance (*):
                                <br />
                                <br />
                                · Arc Attack (archery) (*)
                                <br />
                                · Canopy Park (Zip-line park and hanging bridges crossings) (*)
                                <br />
                                · Spartan Trail 
                                <br />
                                · Kayaking
                    ...
                    <div class="col-md-6">
                        <div style="background-color: rgba(0,0,0,.5);">
                            ...
                            <p style="opacity: 1 !important; padding-left: 15px; padding-right: 15px; padding-top: 15px; text-align: left; font-family: Quicksand; font-size: 25px; font-weight: 300; color: white; z-index: 25;">When can the activities be carried out?</p>
                            <p style="padding-left: 15px; padding-right: 15px; padding-bottom: 15px; text-align: left; font-family: Quicksand; font-size: 15px; font-weight: 200; color: white">                                                    
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div style="background-color: rgba(0,0,0,.5);">
                            ...
                            <p style="opacity: 1 !important; padding-left: 15px; padding-right: 15px; padding-top: 15px; text-align: left; font-family: Quicksand; font-size: 25px; font-weight: 300; color: white; z-index: 25;">Is there a minimum/maximum number of participants in each activity?</p>
                            <p style="padding-left: 15px; padding-right: 15px; padding-bottom: 15px; text-align: left; font-family: Quicksand; font-size: 15px; font-weight: 200; color: white">
                    ...
                    <div class="col-md-6">
                        <div style="background-color: rgba(0,0,0,.5);">
                            ...
                            <p style="opacity: 1 !important; padding-left: 15px; padding-right: 15px; padding-top: 15px; text-align: left; font-family: Quicksand; font-size: 25px; font-weight: 300; color: white; z-index: 25;">Is there any age, height or weight limitations, or any recommendations to participate in the activities?</p>
                            <p style="padding-left: 15px; padding-right: 15px; padding-bottom: 15px; text-align: left; font-family: Quicksand; font-size: 15px; font-weight: 200; color: white">
                                <u>Requirements:</u>
                                <br />
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div style="background-color: rgba(0,0,0,.5);">
                            ...
                            <p style="opacity: 1 !important; padding-left: 15px; padding-right: 15px; padding-top: 15px; text-align: left; font-family: Quicksand; font-size: 25px; font-weight: 300; color: white; z-index: 25;">Can I stay in Wakana Lake?, when?</p>
                            <p style="padding-left: 15px; padding-right: 15px; padding-bottom: 15px; text-align: left; font-family: Quicksand; font-size: 15px; font-weight: 200; color: white">
                                Of course. We have a total capacity of 150 places in different types of accommodations: Andalusian cortijo (60), tepees (48) and yurts (42).. Our opening calendar to the public is:<br />
                                <br />
                    ...
                    <div class="col-md-6">
                        <div style="background-color: rgba(0,0,0,.5);">
                            <p style="opacity: 1 !important; padding-left: 15px; padding-right: 15px; padding-top: 15px; text-align: left; font-family: Quicksand; font-size: 25px; font-weight: 300; color: white; z-index: 25;">Is there a restaurant in Wakana Lake?</p>
                            <p style="padding-left: 15px; padding-right: 15px; padding-bottom: 15px; text-align: left; font-family: Quicksand; font-size: 15px; font-weight: 200; color: white">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div style="background-color: rgba(0,0,0,.5);">
                            ...
                            <p style="opacity: 1 !important; padding-left: 15px; padding-right: 15px; padding-top: 15px; text-align: left; font-family: Quicksand; font-size: 25px; font-weight: 300; color: white; z-index: 25;">Is it possible to camp with tent or caravan / auto-caravan in Wakana Lake?</p>
                            <p style="padding-left: 15px; padding-right: 15px; padding-bottom: 15px; text-align: left; font-family: Quicksand; font-size: 15px; font-weight: 200; color: white">
