...
{
    public partial class Tepees : System.Web.UI.Page
    {
        ...
        protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
        {
            ...
            if (cul != null)
            {
                ...
                UICulture = cul;
                InitializeCulture();
                Response.Redirect("Tepees.aspx", false);
            }
        }
        ...
        private void LoadImages()
        {
            ...
            string PATH = "gallery/Accomodation/Tepees/";
            ...
            foreach (string listadecadena in this.listadecadenas)
            {
                ...
                {
                    str3 = string.Concat(new string[] { str3, "../", PATH, this.listadecadenas[j], ", \r\n" });
                }
                for (int k = 0; k < num - 1; k++)
                {
                    str3 = string.Concat(new string[] { str3, "../", PATH, this.listadecadenas[k], ", \r\n" });
                }
