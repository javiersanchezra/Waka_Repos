...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <section class="section swatch-blue text-center section-text-shadow section-no-inner-shadow">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 primercol"><a class="lobstertitle" style="font-size: 6vw;">Welcome to Happiness</a></div>
            </div>
            <div class="row">
                <div class="col-md-12">
                                        ...
                                        <div class="row" style="margin-right: 0px !important; margin-bottom: 15px !important;"  >
                                            <div class="col-xs-3"  id="divlake" style="padding: 2px;" onclick="myFunction(this)">
                                             <a href="#" class="portfolio-filter" data-filter=".filter-lake">
                                                                             <div   id="facesab" class="tp-caption Newspaper-Button" style="z-index: 108; white-space: nowrap; text-transform: left; outline: none; box-shadow: none; box-sizing: border-box; -moz-box-sizing: border-box; -webkit-box-sizing: border-box; cursor: pointer; font-family: 'Josefin Sans';">Wakana Lake </div>
                                                                    </a>
                                                    </div>
                                                                     ...
                                                                     <div class="col-xs-3"  id="divfaces" style="padding: 2px;" onclick="myFunction(this)">
                                                                         <a href="#" class="portfolio-filter" data-filter=".filter-faces">
                                                                             <div   id="facesa" class="tp-caption Newspaper-Button" style="z-index: 108; white-space: nowrap; text-transform: left; outline: none; box-shadow: none; box-sizing: border-box; -moz-box-sizing: border-box; -webkit-box-sizing: border-box; cursor: pointer; font-family: 'Josefin Sans';">Faces </div>
                                                                    </a> </div>
                                                                     ...
                                                                     <div class="col-xs-3" id="divact" style="padding: 2px;"  onclick="myFunction(this)">
                                                                         <a href="#" class="portfolio-filter" data-filter=".filter-activities">
                                                                             <div   id="activitiesa" class="tp-caption Newspaper-Button"  style="z-index: 108; white-space: nowrap; text-transform: left; outline: none; box-shadow: none; box-sizing: border-box; -moz-box-sizing: border-box; -webkit-box-sizing: border-box; cursor: pointer; font-family: 'Josefin Sans';">Activities </div>
                                                                      </a> </div>
