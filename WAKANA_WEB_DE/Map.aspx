...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <section class="section swatch-blue text-center section-text-shadow section-no-inner-shadow">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 primercol"><a class="lobstertitle">Wakana Lake Map</a></div>
            </div>
            <div class="row">
                <div class="col-md-12">
            ...
            <div class="row">
                <div class="col-md-12">
                                  ...
                                  <a href="https://www.google.com.mx/maps/place/WAKANA+LAKE/@36.3100875,-5.7428419,15z/data=!4m2!3m1!1s0x0:0x1925801980d6b5aa?sa=X&ved=0ahUKEwjNoJqt-MXRAhUBw4MKHcgtBLwQ_BIIeDAP" class="wakanasublink" style="font-family: Quicksand; font-size: 40px; text-align: center;">Get Directions</a>
                    </br>
                </div>
                </br>
