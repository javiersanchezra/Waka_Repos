...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <section class="section swatch-blue text-center section-text-shadow section-no-inner-shadow">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 primercol"><a class="lobstertitle"><asp:Literal runat="server" ID="Literal1" Text="<%$ Resources:Index, partnersnuestros %>"></asp:Literal></a></div>
        ...
        <div class="row">
              <div class="col-sm-6 col-xs-12">
                  ...
                  <a href="Activities.aspx" class="wakanasublink"><asp:Literal runat="server" ID="Literal2" Text="<%$ Resources:Index, partnersexplorar %>"></asp:Literal></a>
            </div>
              <div class="col-sm-6 col-xs-12">
                  ...
                  <a href="Activities.aspx" class="wakanasublink"><asp:Literal runat="server" ID="Literal3" Text="<%$ Resources:Index, partnersexplorar %>"></asp:Literal></a></br>
            </div>
            </div></br></br>
            <div class="row">
                  <div class="col-xs-12" >
                <a  href="#" onclick="ShowContactMod();return false;" style="color:white;"  class="cmn-t-underline" ><asp:Literal runat="server" ID="Literal4" Text="<%$ Resources:Index, partnerscolabora %>"></asp:Literal></a></br>
                      </div>
            </div>
           </br>
         </div>
