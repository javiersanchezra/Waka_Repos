...
namespace WAKANA_WEB_DE
{
    public partial class SummerCamps : System.Web.UI.Page
    {
        ...
        private string query2 = "SELECT id, days, titulo as titulo, texto, CONCAT('~/GetImage.aspx?type=summercampslogo&image=',id) AS imagen FROM summercamps";
        ...
        protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
        {
            ...
            if (cul != null)
            {
                ...
                UICulture = cul;
                InitializeCulture();
                Response.Redirect("SummerCamps.aspx", false);
            }
        }
