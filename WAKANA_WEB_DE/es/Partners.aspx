...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <section class="section swatch-blue text-center section-text-shadow section-no-inner-shadow">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 primercol"><a class="lobstertitle">Nuestros Colaboradores</a></div>
        ...
        <div class="row">
              <div class="col-sm-6 col-xs-12">
                  ...
                  <a href="Activities.aspx" class="wakanasublink">EXPLORAR ACTIVIDADES</a>
            </div>
              <div class="col-sm-6 col-xs-12">
                  ...
                  <a href="Activities.aspx" class="wakanasublink">EXPLORAR ACTIVIDADES</a></br>
            </div>
            </div></br></br>
            <div class="row">
                  <div class="col-xs-12" >
                <a  href="#" onclick="ShowContactMod();return false;" style="color:white;"  class="cmn-t-underline" >COLABORA CON NOSOTROS</a></br>
                      </div>
            </div>
           </br>
         </div>
