<%@ Page Title="" Language="C#" MasterPageFile="~/es/Main.Master" AutoEventWireup="true" CodeBehind="BocalanCamps.aspx.cs" Inherits="WAKANA_WEB_DE.es.BocalanCamps" %>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 primercol">
                    <div class="lobstertitle" style="text-align: left !important;">Campamentos Bocalan</div>
                    <div style="font-family: Quicksand; color: white; font-size: 35px; text-align: left !important;">FECHAS 2017</div>
                </div>
            </div>
