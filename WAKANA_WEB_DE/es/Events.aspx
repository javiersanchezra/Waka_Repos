<%@ Page Title="" Language="C#" MasterPageFile="~/es/Main.Master" AutoEventWireup="true" CodeBehind="Events.aspx.cs" Inherits="WAKANA_WEB_DE.es.Events" %>
            ...
            <div class="portfolio-container element-normal-top element-no-bottom">
                ...
                <div class="row" style="margin-top: 10px; margin-left: 0px; margin-right: 0px; margin-bottom: 10px;">
                    ...
                    <div class="col-md-2 col-md-offset-6 col-sm-3 col-sm-offset-6   col-xs-6   eventsbutton">
                        <div class="row" style="margin-top: 10px; margin-left: 0px; margin-right: 0px; margin-bottom: 10px;">
                            <div class="col-xs-6" >
                                <a href="#" onclick="ShowList();return false;" style="color:white;">  DÍA </a>
                            </div>
                           
                         <div class="col-xs-6">
                             
                             <a href="#" onclick="ShowCalendar();return false;" style="color:white;">  MES </a>
                            </div>
                        </div>
                    </div>
                   </br>
                    ...
                    <div class="col-md-10 col-md-offset-1" style="background-color:rgba(0, 0, 0, 0.50); margin-top:15px;" >
                                             <iframe src="https://calendar.google.com/calendar/embed?src=tvjqm9cojg3cm03suit6ukctl4%40group.calendar.google.com&ctz=America/Mexico_City" style="border: 0" width="100%" height="500px" frameborder="0" scrolling="no"></iframe>
                      </div></div>
                                        </dx:PanelContent>
                                    </PanelCollection>
                                </dx:ASPxPanel>
