    ...
    public partial class Faces : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            foreach (string listadecadena in this.listadecadenas)
            {
                ...
                {
                    str3 = string.Concat(new string[] { str3, "../", str1, this.listadecadenas[j], ", \r\n" });
                }
                for (int k = 0; k < num - 1; k++)
                {
                    str3 = string.Concat(new string[] { str3, "../", str1, this.listadecadenas[k], ", \r\n" });
                }
            ...
            foreach (string listadecadena1 in this.listadecadenas)
            {
                ...
                {
                    str6 = string.Concat(new string[] { str6, "../", str1, this.listadecadenas[l], ", \r\n" });
                }
                for (int m = 0; m < num - 1; m++)
                {
                    str6 = string.Concat(new string[] { str6, "../", str1, this.listadecadenas[m], ", \r\n" });
                }
            ...
            foreach (string listadecadena2 in this.listadecadenas)
            {
                ...
                {
                    str9 = string.Concat(new string[] { str9, "../", str1, this.listadecadenas[n], ", \r\n" });
                }
                for (int o = 0; o < num - 1; o++)
                {
                    str9 = string.Concat(new string[] { str9, "../", str1, this.listadecadenas[o], ", \r\n" });
                }
