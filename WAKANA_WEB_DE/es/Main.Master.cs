...
namespace WAKANA_WEB_DE.es
{
    public partial class Main : System.Web.UI.MasterPage
    {
        ...
        protected void camp_WindowCallback(object source, PopupWindowCallbackArgs e)
        {
            ...
            string str1 = string.Concat("SELECT id, days, titulo, tituloingles, texto, CONCAT('img/camps/',imagen) AS imagen, CONCAT('img/camps/',imagencamp) AS imagencamp FROM schoolcamps WHERE id =", str);
