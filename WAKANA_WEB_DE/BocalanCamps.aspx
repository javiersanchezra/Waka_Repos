<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="BocalanCamps.aspx.cs" Inherits="WAKANA_WEB_DE.BocalanCamps" %>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 primercol">
                    <div class="lobstertitle" style="text-align: left !important;"><asp:Literal runat="server" ID="Literal1" Text="<%$ Resources:Index, campamentobocalantitulo %>"></asp:Literal></div>
                    <div style="font-family: Quicksand; color: white; font-size: 35px; text-align: left !important;"><asp:Literal runat="server" ID="Literal2" Text="<%$ Resources:Index, bocalanfecha %>"></asp:Literal></div>
                </div>
            </div>
            <div class="row">
                    ...
                    <ItemTemplate>
                        <div class="col-md-3 col-sm-6 col-xs-12">
                            <div class="CAMP">
                                ...
                                <a href="#" onclick="ShowModal('<%# Eval("id") %>', 'bocalan');return false;">
                                    <div class="buttonmoreinfo"><asp:Literal runat="server" ID="Literal1" Text="<%$ Resources:Index, bocalanmasinfo %>"></asp:Literal></div>
                                </a>
                            </div>
                        </div>
                    </ItemTemplate>
