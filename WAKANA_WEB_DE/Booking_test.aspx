<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Booking_test.aspx.cs" Inherits="WAKANA_WEB_DE.Booking_test" %>
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li>
                                    <a href="#">Wakana Lake Summers Camps
                                                    
                                    </a>
                                </li>
                                <li>
                                    <a href="#">Spartan Race Camps
                        ...
                        <li class="dropdown">
                            <a href="/es/Default.aspx" style="font-size: 30px;">
                                <img style="padding-bottom: 10px" width="34px" height="20px" src="assets/images/spain.jpg"></img></a>

                        </li>
                        <li>
                            <a href="#" onclick="ShowBooking();return false;">
                                <div class="buttonmoreinfo">BOOKING</div>
                            </a>
