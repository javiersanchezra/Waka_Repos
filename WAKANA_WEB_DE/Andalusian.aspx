<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="Andalusian.aspx.cs" Inherits="WAKANA_WEB_DE.Andalusian" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <section class="section swatch-blue text-center section-text-shadow section-no-inner-shadow">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 primercol"><a class="lobstertitle"><asp:Literal runat="server" ID="Literal10" Text="<%$ Resources:Index, andacortijoandaluz %>"></asp:Literal></a></div>
            </div>
            <div class="row">
                <div class="col-md-3 col-sm-4 col-xs-6 ">
                    <a href="../../Precios Web_ENG.pdf" target="_blank">
                        <div id="facesa" class="tp-caption Newspaper-Button" style="z-index: 108; white-space: nowrap; text-transform: left; outline: none; box-shadow: none; box-sizing: border-box; -moz-box-sizing: border-box; -webkit-box-sizing: border-box; cursor: pointer; text-align: center; font-family: 'Quicksand';"><asp:Literal runat="server" ID="Literal1" Text="<%$ Resources:Index, andaprecios %>"></asp:Literal></div>
                    </a>
                </div>
