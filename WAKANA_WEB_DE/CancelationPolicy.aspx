<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="CancelationPolicy.aspx.cs" Inherits="WAKANA_WEB_DE.CancelationPolicy" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li>
                                    <a href="Andalusian.aspx"><asp:Literal runat="server" ID="Literal5" Text="<%$ Resources:Index, cortijoandaluz %>"></asp:Literal>   
                                    </a>
                                </li>
                                 <li>
    ...
    <section class="section swatch-blue text-center section-text-shadow section-no-inner-shadow">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 primercol"><a class="lobstertitle"><asp:Literal runat="server" ID="Literal18" Text="<%$ Resources:Index, cancelpoltitulo %>"></asp:Literal></a></div>
            </div>
            <div class="row">
                <div class="col-md-12">
                    <div class="portfolio-container element-normal-top element-no-bottom debajotitulo" style="text-align: left; margin-top: 20px !important;">
                        • <asp:Literal runat="server" ID="Literal1" Text="<%$ Resources:Index, cancelpolsicancelas1 %>"></asp:Literal></br>
                        • <asp:Literal runat="server" ID="Literal2" Text="<%$ Resources:Index, cancelpolsicancelas2 %>"></asp:Literal></br>
                        • <asp:Literal runat="server" ID="Literal3" Text="<%$ Resources:Index, cancelpolsinotepresentas %>"></asp:Literal>.</br>
                        • <asp:Literal runat="server" ID="Literal4" Text="<%$ Resources:Index, cancelpolelestable %>"></asp:Literal></br>
