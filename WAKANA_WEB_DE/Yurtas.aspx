<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="Yurtas.aspx.cs" Inherits="WAKANA_WEB_DE.Yurtas" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                ...
                <div class="navbar-header">
                 ...
                 <nav class="collapse navbar-collapse main-navbar" role="navigation">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="dropdown">
                            <a href="Place.aspx" class="dropdown-toggle" data-toggle="dropdown" ><asp:Literal runat="server" ID="Literal2" Text="<%$ Resources:Index, lugar %>"></asp:Literal></a>
    ...
    <section class="section swatch-blue text-center section-text-shadow section-no-inner-shadow">
        ...
        <div class="background-media" style="background-image: url('../img/slide/backyurtas.jpg'); background-repeat: no-repeat; background-size: cover; background-attachment: fixed; background-position: 50% 0px;" data-start="background-position:50% 0px"
            data-70-top-bottom="background-position:50% -120px">
        </div>
        <div class="background-overlay  " style="background-color: rgba(0,0,0,0.4);"></div>
        <div class="container">
            <div class="row">
                <div class="col-md-12 primercol"><a class="lobstertitle"><asp:Literal runat="server" ID="Literal1" Text="<%$ Resources:Index, yurtasyurtas %>"></asp:Literal></a></div>
            </div>
            <div class="row">
                <div class="col-md-3 col-sm-4 col-xs-6 ">
                    ...
                    <a href="../../Precios Web_ENG.pdf" target="_blank">
                        <div id="facesa" class="tp-caption Newspaper-Button" style="z-index: 108; white-space: nowrap; text-transform: left; outline: none; box-shadow: none; box-sizing: border-box; -moz-box-sizing: border-box; -webkit-box-sizing: border-box; cursor: pointer; text-align: center; font-family: 'Quicksand';"><asp:Literal runat="server" ID="Literal10" Text="<%$ Resources:Index, yurtasprecios %>"></asp:Literal></div>
                    </a>
                </div>
