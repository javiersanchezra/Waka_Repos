<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="SummerCamps.aspx.cs" Inherits="WAKANA_WEB_DE.SummerCamps" %>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 primercol">
                    <div class="lobstertitle" style="text-align: left !important;"><asp:Literal runat="server" ID="Literal30" Text="<%$ Resources:Index, summercampscampamentodeverano %>"></asp:Literal></div>
                    <div style="font-family: Quicksand; color: white; font-size: 35px; text-align: left !important;"><asp:Literal runat="server" ID="Literal1" Text="<%$ Resources:Index, summercampsfechas2017 %>"></asp:Literal></div>
                </div>
            </div>
                    ...
                    <ItemTemplate>
                        <div class="col-md-3 col-sm-6 col-xs-12">
                            ...
                            <div class="CAMP">
                                ...
                                <a href="#" onclick="ShowModal('<%# Eval("id") %>', 'school');return false;">
                                    <div class="buttonmoreinfo"><asp:Literal runat="server" ID="Literal1" Text="<%$ Resources:Index, summercampsmasinfo %>"></asp:Literal> </div>
                                </a>
